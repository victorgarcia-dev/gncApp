...
import { SuccessfulShiftAlert } from '../../../components/SuccessfulShiftAlert';
...
export const CrearTurnoUsuario = () => {
  ...
  const handleCreateTurner = (formData: Turner) => { 
      ...
      setStatus(true);
      setInfoTurner(formData)
  }

  return (
    <>
      { status ? (
          <SuccessfulShiftAlert 
              infoUser= {infoTurner}
           />
        ) : (
         ""
